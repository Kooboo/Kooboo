...
namespace Kooboo.HttpServer
{
    public class HttpConnectionManager
    {
        ...
        public HttpConnectionManager(ILogger logger, long? upgradedConnectionLimit)
            : this(logger, GetCounter(upgradedConnectionLimit))
        {
        }

        public HttpConnectionManager(ILogger logger, ResourceCounter upgradedConnections)
        {
