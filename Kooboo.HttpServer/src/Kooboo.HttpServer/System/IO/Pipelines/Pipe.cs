...
namespace System.IO.Pipelines
{
    ...
    public class Pipe : IAwaiter<ReadResult>, IAwaiter<FlushResult>
    {
        ...
        private class ResetablePipeReader : PipeReader
        {
            ...
            public override ValueAwaiter<ReadResult> ReadAsync(CancellationToken cancellationToken = default(CancellationToken))
            {
        ...
        private class ResetablePipeWriter : PipeWriter
        {
            ...
            public override ValueAwaiter<FlushResult> FlushAsync(CancellationToken cancellationToken = default(CancellationToken))
            {
