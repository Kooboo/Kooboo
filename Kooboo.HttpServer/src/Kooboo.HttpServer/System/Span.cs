...
namespace System
{
    ...
    public struct Span<T>
    {
        ...
        /// </summary>
        public static implicit operator Span<T>(T[] array) => array != null ? new Span<T>(array) : default(Span<T>);

        /// <summary>
        /// Defines an implicit conversion of a <see cref="ArraySegment{T}"/> to a <see cref="Span{T}"/>
        /// </summary>
        public static implicit operator Span<T>(ArraySegment<T> arraySegment)
            => arraySegment.Array != null ? new Span<T>(arraySegment.Array, arraySegment.Offset, arraySegment.Count) : default(Span<T>);
