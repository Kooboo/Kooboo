...
namespace System.Buffers
{
    ...
    public struct StandardFormat : IEquatable<StandardFormat>
    {
        ...
        /// Converts a classic .NET format string into a StandardFormat
        /// </summary>
        public static StandardFormat Parse(string format) => format == null ? default(StandardFormat) : Parse(MemoryExtensions.AsReadOnlySpan(format));  //@todo: Change back to extension syntax once the ambiguous reference with CoreLib is eliminated.
