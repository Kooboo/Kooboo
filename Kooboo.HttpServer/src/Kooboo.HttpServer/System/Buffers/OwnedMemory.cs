    ...
    public abstract class OwnedMemory<T> : IDisposable, IRetainable
    {
        ...
        public Memory<T> Memory
        {
            get
            {
                if (IsDisposed)
                {
                    System.ThrowHelper.ThrowObjectDisposedException_MemoryDisposed(nameof(OwnedMemory<T>));
                }
        ...
        public void Dispose()
        {
            if (IsRetained)
            {
                System.ThrowHelper.ThrowInvalidOperationException_OutstandingReferences();
            }
            Dispose(true);
