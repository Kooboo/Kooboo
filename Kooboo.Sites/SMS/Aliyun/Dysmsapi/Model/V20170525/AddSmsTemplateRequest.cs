...
{
    public class AddSmsTemplateRequest : RpcAcsRequest<AddSmsTemplateResponse>
    {
        public AddSmsTemplateRequest()
            : base("Dysmsapi", "2017-05-25", "AddSmsTemplate", "dysms", "openAPI")
        {
        ...
        public override AddSmsTemplateResponse GetResponse(UnmarshallerContext unmarshallerContext)
        {
            return AddSmsTemplateResponseUnmarshaller.Unmarshall(unmarshallerContext);
        }
    }
}
