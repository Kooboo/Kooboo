...
namespace Kooboo.Sites.Ecommerce.DataSource
{
    ...
    public class EcommerceProduct : SiteDataSource
    {
        ...
        public List<ViewModel.CategoryViewModel> TopCategories()
        {
            ...
            var all = sitedb.Category.All().Where(o => o.ParentId == default(Guid)).ToList();
        ...
        public List<ViewModel.CategoryViewModel> SubCategories(Guid id)
        {
            ...
            var all = sitedb.Category.All().Where(o => o.ParentId == id).ToList();
        ...
        public List<ViewModel.ProductViewModel> ListByCategoryName(string name)
        {
            ...
            var allproducts = this.Context.SiteDb.Product.GetByCategory(id);
            ...
            {
                var type = this.Context.SiteDb.ProductType.Get(item.ProductTypeId);
        ...
        {   
            var allproducts = this.Context.SiteDb.Product.All();  
        ...
        private HashSet<Guid> GetAllSubCats(Guid Id)
        {
            ...
            var all = this.Context.RenderContext.WebSite.SiteDb().Category.All();
            result.Add(Id);
