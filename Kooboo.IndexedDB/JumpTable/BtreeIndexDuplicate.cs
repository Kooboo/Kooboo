...
namespace Kooboo.IndexedDB.Btree
{
    ...
    {
        //this design use 4 jumb linked table, each sub containns 10 records.  See end of this file for design. 
        // this might not be the best efficient search that use 10 sub records. It is only a guess now. use of 50% chance upgrade theory when inserting in the jumb table theory is not effecitive. 
        ...
        public FileStream IndexStream
        {
            get
            {
                ...
                {
                    _indexstream = File.Open(this.fullfilename, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite);
        ...
        private enumSectionType getIndicator(Int64 startSectionPosition)
        {
            ...
            int indicatorbyte = IndexStream.ReadByte();
