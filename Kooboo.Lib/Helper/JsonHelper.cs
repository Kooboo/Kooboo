...
namespace Kooboo.Lib.Helper
{
    public static class JsonHelper
    {
        ...
        public static System.Text.Json.JsonElement MsDeserialize(string json)
        {
            var result = System.Text.Json.JsonSerializer.Deserialize(json, typeof(System.Text.Json.JsonElement));

            return (System.Text.Json.JsonElement)result;
        }

        public static T MsDeserialize<T>(string json)
        {
            var result = System.Text.Json.JsonSerializer.Deserialize(json, typeof(T));
        ...
        public static object ToJSObject(string json)
        {
            Jint.Native.Json.JsonParser praser = new Jint.Native.Json.JsonParser(new Jint.Engine());
            var obj = praser.Parse(json);
            if (obj != null && obj.Type != Jint.Runtime.Types.Undefined)
            {
                return obj.ToObject();
            }
            return null;
