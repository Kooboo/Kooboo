...
namespace Kooboo.Lib.Helper
{
    ...
    {
        public static string KoobooAppData { get; set; }

        static IOHelper()
        {
            var appDataPath = Environment.GetEnvironmentVariable("KOOBOO_APPDATA");
            if (string.IsNullOrWhiteSpace(appDataPath))
            {
                ...
                appDataPath = Path.Combine(basePath, "kooboo");
            }
            KoobooAppData = appDataPath;
        }
        ...
        public static string ReadAllText(string FullFileName)
        {
            if (System.IO.File.Exists(FullFileName))
            {
        ...
        public static void WriteAllText(string FullFileName, string Json)
        {
            FileStream stream = File.Create(FullFileName);
