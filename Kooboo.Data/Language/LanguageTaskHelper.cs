    ...
    public static class LanguageTaskHelper
    {
        public static List<LanguageTask> ParseDom(string input)
        {
            ...
            while (nextnode != null)
            {
                ...
                {
                    if (nextnode is Text textndoe && MultiLingualHelper.IsMultilingualKey(textndoe.data))
                    {
                ...
                else if (nextnode.nodeType == enumNodeType.ELEMENT)
                {
                    ...
                    if (el != null && (el.tagName == "script" || el.tagName == "link" || el.tagName == "style" || el.tagName == "meta"))
                    {
                    ...
                    if (el != null)
                    {
                        ...
                        if (MultiLingualHelper.IsMultilingualKey(title) || MultiLingualHelper.IsMultilingualKey(placeholder))
                        {
                            ...
                            tasklist.Add(Helper.DomHelper.IsSelfCloseTag(el.tagName)
                                ? new LanguageTask(" />", false)
                                : new LanguageTask(">", false));
