...
namespace Kooboo.Data.Helper
{
    public class DataTypeHelper
    {
        ...
        {
            return Enum.GetValues(typeof(DataTypes)).Cast<DataTypes>().ToDictionary(dataType => dataType, dataType => DataTypeHelper.GetSupportedComparers(dataType).Select(x => new ComparerModel {Name = x.ToString(), Symbol = Data.Helper.ComparerHelper.GetSymbol(x)}).ToArray());
        }
    }
}