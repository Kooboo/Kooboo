...
define(
  ...
  function (Arr, Fun, Element, Traverse, Awareness, Selection, WindowSelection) {
    ...
    var getRectangles = function (cWin) {
      var sel =cWin.getSelection && cWin.getSelection();
      ...
      return sel !== undefined && sel && sel.rangeCount > 0 ? getRectsFromRange(sel.getRangeAt(0)) : [ ];
    };
    ...
    ThemeManager.add('mobile', function (editor) {
      var renderUI = function (args) {
		...
		var back = {
		 ...
		 var group=editor.settings.directEdit?back:backToReadOnlyGroup;
          var mainGroups = Cell([ group, actionGroup, extraGroup ]);
		  ...
		  if (editor.settings.directEdit) {
			  setReadOnly(readOnlyGroups, mainGroups, false);
			  realm.enter();
		  }
        });
