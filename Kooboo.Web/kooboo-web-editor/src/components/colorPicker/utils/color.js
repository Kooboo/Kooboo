  ...
  invalid: for (const type in regex) {
    ...
    switch (type) {
      ...
      case "rgba": {
        ...
        if (r > 255 || g > 255 || b > 255 || a < 0 || a > 1 || alpha === !a) break invalid;
      ...
      case "hsla": {
        ...
        if (h > 360 || s > 100 || l > 100 || a < 0 || a > 1 || alpha === !a) break invalid;
      ...
      case "hsva": {
        ...
        if (h > 360 || s > 100 || v > 100 || a < 0 || a > 1 || alpha === !a) break invalid;
