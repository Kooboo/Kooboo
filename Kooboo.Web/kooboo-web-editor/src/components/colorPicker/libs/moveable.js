...
export default function Moveable(opt) {
  const that = {
    ...
    _tapstart(evt) {
      _.on(parent.document, ["mouseup", "touchend", "touchcancel"], that._tapstop);
      _.on(parent.document, ["mousemove", "touchmove"], that._tapmove);
    ...
    _tapstop() {
      that.options.onstop();
      _.off(parent.document, ["mouseup", "touchend", "touchcancel"], that._tapstop);
      _.off(parent.document, ["mousemove", "touchmove"], that._tapmove);
    },
