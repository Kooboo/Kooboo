...
import { createDeleteFormItem } from "@/components/floatMenu/items/deleteForm";
...
describe("deleteForm", ()=>{
    ...
    test("createDeleteFormItem_update", ()=>{
        document.body.innerHTML = `
        ...
        <div class="widget widget-intro" kooboo-id="1-0">
            <article class="content" kooboo-id="1-0-1-1-1-1">
                <!--#kooboo--objecttype='form'--nameorid='form1'--boundary='155'-->
                <h2 class="title" kooboo-id="1-0-1-1-1-1-1">平等，责任</h2>
                <!--#kooboo--end='true'--objecttype='form'--boundary='155'-->
        ...
        let elementObject = createDeleteFormItem();
    ...
    test("createDeleteFormItem_update_noExistInForm", ()=>{
        document.body.innerHTML = `
        <!--#kooboo--objecttype='view'--nameorid='member'--boundary='154'-->
        <div class="widget widget-intro" kooboo-id="1-0">
            <article class="content" kooboo-id="1-0-1-1-1-1">
