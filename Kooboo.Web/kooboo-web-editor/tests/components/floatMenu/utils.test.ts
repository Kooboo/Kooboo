import { getEditComment, getViewComment, getAttributeComment, hasOperation, getMenuComment, getFormComment, getHtmlBlockComment, getRepeatComment, getUrlComment, changeNameOrId } from "@/components/floatMenu/utils";
...
describe("utils", ()=>{
    ...
    test("getEditComment", ()=>{
        let editComment = new KoobooComment("#kooboo--objecttype='content'--nameorid='e695ad0d-4db9-92e2-0bd6-739bd6c94531'--bindingvalue='List_Item.name'--fieldname='name'--koobooid='1-0-1-1-1-1-3'");
        let noEditComment = new KoobooComment("#kooboo--objecttype='contentrepeater'--nameorid='d8eee011-69d3-0a6c-632f-822df385ab3c'--folderid='ffa232c4-ca49-9c07-8b43-fd30d5ec5e8b'--bindingvalue='List_Item'--boundary='111'")
    ...
    test("getViewComment", ()=>{
        ...
        let noViewComment = new KoobooComment("#kooboo--objecttype='contentrepeater'--nameorid='d8eee011-69d3-0a6c-632f-822df385ab3c'--folderid='ffa232c4-ca49-9c07-8b43-fd30d5ec5e8b'--bindingvalue='List_Item'--boundary='111'")
    ...
    test("getAttributeComment", ()=>{
        let srcAttributeComment = new KoobooComment("#kooboo--objecttype='attribute'--nameorid='27bf63e5-d18d-3899-f00b-536800d2c6e2'--attributename='src'--bindingvalue='{ListItem.img}'--koobooid='1-0-1-1-3-1'");
        let classAttributeComment = new KoobooComment("#kooboo--objecttype='attribute'--nameorid='27bf63e5-d18d-3899-f00b-536800d2c6e3'--attributename='class'--bindingvalue='{ListItem.img}'--koobooid='1-0-1-1-3-1'");
        let noAttributeComment = new KoobooComment("#kooboo--objecttype='contentrepeater'--nameorid='d8eee011-69d3-0a6c-632f-822df385ab3c'--folderid='ffa232c4-ca49-9c07-8b43-fd30d5ec5e8b'--bindingvalue='List_Item'--boundary='111'")
    ...
    test("getMenuComment", ()=>{
        ...
        let suportComment = new KoobooComment("#kooboo--objecttype='contentrepeater'--nameorid='d8eee011-69d3-0a6c-632f-822df385ab3c'--folderid='ffa232c4-ca49-9c07-8b43-fd30d5ec5e8b'--bindingvalue='List_Item'--boundary='111'")
    ...
    test("getRepeatComment", ()=>{
        ...
        let comment = new KoobooComment("#kooboo--objecttype='contentrepeater'--nameorid='d8eee011-69d3-0a6c-632f-822df385ab3c'--folderid='ffa232c4-ca49-9c07-8b43-fd30d5ec5e8b'--bindingvalue='List_Item'--boundary='111'")
    ...
    test("changeNameOrId", ()=>{
        let comment = document.createComment("#kooboo--objecttype='content'--nameorid='e695ad0d-4db9-92e2-0bd6-739bd6c94531'--bindingvalue='List_Item.name'--fieldname='name'--koobooid='1-0-1-1-1-1-3'");
