...
namespace Kooboo.Web.Api.Implementation
{
    ...
    public class BarApi : IApi
    {
        ...
        {
            Kooboo.Sites.Market.Authorize.StoreToken(call.Context);
        ...
        public virtual List<CmsMenuViewModel> SiteMenu(ApiCall call)
        {
            var user = call.Context.User;
        ...
        private CmsMenuViewModel SiteBarAdvancedMenu(ApiCall call)
        {
            ...
            var development =
                new CmsMenuViewModel(SideBarSection.Development.ToString(), Hardcoded.GetValue("Development", context))
                { Icon = "icon fa fa-code" };
            var content =
                new CmsMenuViewModel(SideBarSection.Contents.ToString(), Hardcoded.GetValue("Contents", context))
                { Icon = "icon fa fa-files-o" };
            var database =
                new CmsMenuViewModel(SideBarSection.Database.ToString(), Hardcoded.GetValue("Database", context))
                { Icon = "icon fa fa-database" };
            var commerce =
                new CmsMenuViewModel(SideBarSection.Commerce.ToString(), Hardcoded.GetValue("Commerce", context))
                { Icon = "icon fa fa-database" };
            ...
            var sitebarmenus = MenuContainer.SideBarMenus
                .Where(w => !Attribute.IsDefined(w.GetType(), typeof(ApiVersionAttribute)))
                .ToArray();
        ...
        public List<MenuItem> EmailMenu(ApiCall call)
        {
            ...
            var addresses = orgdb.Email.ByUser(context.User.Id);

            return new MenuItem[]
            {
                new MenuItem
                {
                    Name = Hardcoded.GetValue("Inbox", context), Icon = "icon glyphicon glyphicon-inbox",
                    Url = AdminUrl("emails/inbox"), Items = EmailMenu_Addresses("Inbox", addresses)
                },
                new MenuItem
                {
                    Name = Hardcoded.GetValue("Sent", context), Icon = "icon fa fa-send", Url = AdminUrl("emails/sent"),
                    Items = EmailMenu_Addresses("Sent", addresses)
                },
                new MenuItem
                {
                    Name = Hardcoded.GetValue("Draft", context), Icon = "icon fa fa-edit",
                    Url = AdminUrl("emails/draft"), Items = EmailMenu_Addresses("Draft", addresses)
                },
                new MenuItem
                {
                    Name = Hardcoded.GetValue("Trash", context), Icon = "icon fa fa-trash",
                    Url = AdminUrl("emails/trash"), Items = EmailMenu_Addresses("Trash", addresses)
                },
                new MenuItem
                {
                    Name = Hardcoded.GetValue("Spam", context), Icon = "icon fa fa-recycle",
                    Url = AdminUrl("emails/spam"), Items = EmailMenu_Addresses("Spam", addresses)
                },
                new MenuItem(),
                new MenuItem
                {
                    Name = Hardcoded.GetValue("Address", context), Icon = "icon fa fa-at",
                    Url = AdminUrl("emails/address")
                }
            }.ToList();
        }
        ...
        public virtual List<MenuItem> DomainMenu(ApiCall call)
        {
            var menus = new MenuItem[]
            {
                new MenuItem
                {
                    Name = Hardcoded.GetValue("Domains", call.Context), Icon = "icon fa fa-at",
                    Url = AdminUrl("Domains")
                },
                new MenuItem
                {
                    Name = Hardcoded.GetValue("SiteBindings", call.Context), Icon = "icon fa fa-link",
                    Url = AdminUrl("Domains/SiteBindings")
                },
